...
public class Q10_WorkflowSystem {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("下一個工作：" + system.peekNext());
        System.out.println("處理：" + system.processNext());
        System.out.println("處理：" + system.processNext());
        System.out.println("復原：" + system.undoLast());
        System.out.println("下一個工作：" + system.peekNext());
        System.out.println("查詢：" + system.findById("t330"));
        System.out.println("等待數量：" + system.waitingCount());
        System.out.println("完成數量：" + system.completedCount());
    }
